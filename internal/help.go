...
var I18n = map[string]map[string]string{
	"zh": {
		...
		"HelpDetail": "-----个人的指令帮助----\n\n" +
			...
			"/p 向某人支付; 例子1: /p tk5.1,rzt u 例子2: /a tk5/3,rzt u (支持分数)\n" +
			"/l 账单; 例子1: /l | 例子2: /l u \n" +
	...
	"en": {
		...
		"HelpDetail": "-----Personal command help----\n\n" +
			...
			"/p Pay someone; Example 1: /p tk5.1,rzt u Example 2: /a tk5/3,rzt u (Fractional support)\n" +
	...
	"ru": {
		...
		"HelpDetail": "-----Персональная команда помощи----\n\n" +
			...
			"/p Оплатить кого-то; Пример 1: /p tk5.1,rzt u Пример 2: /a tk5/3,rzt u (Поддержка дробных)\n" +
